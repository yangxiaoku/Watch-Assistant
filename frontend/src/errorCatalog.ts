...
const ADDITIONAL_CODES = [
  ...
  "invalid_filename", "organization_plan_disabled", "organization_plan_unavailable",
  "organization_execution_disabled", "organization_write_disabled", "organization_write_unverified", "permanent_delete_disabled", "permanent_delete_unverified", "delete_unavailable", "strm_full_disabled", "strm_incremental_disabled", "strm_cleanup_disabled", "strm_unavailable", "organization_operation_unavailable", "plan_not_found",
  ...
  "resource_forbidden", "resource_search_timeout", "settings_conflict", "task_not_retryable",
