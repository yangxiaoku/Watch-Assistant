...
const ADDITIONAL_CODES = [
  ...
  "organization_execution_disabled", "organization_write_disabled", "organization_write_unverified", "permanent_delete_disabled", "permanent_delete_unverified", "delete_unavailable", "strm_full_disabled", "strm_incremental_disabled", "strm_cleanup_disabled", "cleanup_plan_required", "cleanup_plan_already_applied", "strm_unavailable", "strm_operation_failed", "strm_operation_cancelled", "strm_operation_recovered", "strm_operation_timeout", "strm_operation_not_found", "invalid_operation_kind", "invalid_cursor", "invalid_limit", "invalid_operation_timeout", "source_snapshot_not_ready", "source_snapshot_not_current", "strm_output_unavailable", "invalid_playback_url_prefix", "plan_invalid", "cleanup_plan_expired", "cleanup_plan_blocked", "cleanup_plan_changed", "cleanup_plan_not_reviewable", "organization_operation_unavailable", "plan_not_found",
  ...
  "workflow_prerequisite_not_met", "workflow_stage_regression", "workflow_stage_terminal",
