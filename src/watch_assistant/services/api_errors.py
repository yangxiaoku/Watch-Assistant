...
_CATALOG: dict[str, ApiErrorDescriptor] = {
    ...
    "library_health_unavailable": ApiErrorDescriptor("library_health_unavailable", "媒体库体检暂时不可用", "本次健康报告未生成。", "请稍后重试。", True, "retry"),
    "library_health_scan_unavailable": ApiErrorDescriptor("library_health_scan_unavailable", "缺少可用库存扫描", "本次健康报告未生成，当前没有可核对的库存快照。", "请先完成一次只读库存扫描。", False, "open_library"),
    "library_health_scan_not_found": ApiErrorDescriptor("library_health_scan_not_found", "库存扫描不存在", "本次健康报告未生成，指定的库存快照不存在。", "请重新加载媒体库后再试。", False, "open_library"),
    "library_health_report_not_found": ApiErrorDescriptor("library_health_report_not_found", "健康报告不存在", "当前媒体库还没有已保存的健康报告。", "请先运行一次媒体库体检。", False, "open_library"),
    "library_health_report_corrupt": ApiErrorDescriptor("library_health_report_corrupt", "健康报告不可读取", "已保存的健康报告无法读取。", "请重新运行媒体库体检。", True, "retry"),
