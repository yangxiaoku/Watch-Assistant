...
_CATALOG: dict[str, ApiErrorDescriptor] = {
    ...
    "notify_dispatcher_unavailable": ApiErrorDescriptor("notify_dispatcher_unavailable", "通知分发服务暂时不可用", "本次测试通知未发送。", "请稍后重试。", True, "retry"),
    "notify_channel_not_found": ApiErrorDescriptor("notify_channel_not_found", "通知渠道不存在", "本次通知渠道操作未完成。", "请刷新渠道列表后再试。", False, "retry"),
    "notify_channel_decrypt_failed": ApiErrorDescriptor("notify_channel_decrypt_failed", "通知渠道凭据无法读取", "本次测试通知未发送。", "请删除后重新添加该渠道。", False, "reload_settings"),
    "invalid_notify_cli_config": ApiErrorDescriptor("invalid_notify_cli_config", "通知渠道配置无效", "本次测试通知未发送。", "请检查 CLI 渠道的目标和通道配置。", False, "reload_settings"),
    ...
    "dedupe_unavailable": ApiErrorDescriptor("dedupe_unavailable", "去重执行暂不可用", "本次去重未执行，未对 115 做任何删除。", "请确认 115 写入契约与凭据后再试。", False, "inspect_configuration"),
    ...
    "scan_in_progress": ApiErrorDescriptor("scan_in_progress", "扫描正在进行", "本次请求未重复执行扫描。", "请等待当前扫描完成后再试。", True, "retry"),
    "scan_cancel_failed": ApiErrorDescriptor("scan_cancel_failed", "扫描取消失败", "本次扫描没有取消。", "请查看扫描状态后再试。", False),
    "scan_not_current": ApiErrorDescriptor("scan_not_current", "扫描快照不是最新", "本次整理预览未生成，扫描快照不是最新的完整快照。", "请刷新媒体库扫描后再试。", False, "refresh_snapshot"),
    "scan_entry_invalid": ApiErrorDescriptor("scan_entry_invalid", "扫描快照包含无效条目", "本次整理预览未生成，扫描快照包含无效条目。", "请重新扫描媒体库后再试。", False, "refresh_snapshot"),
    "scan_not_found": ApiErrorDescriptor("scan_not_found", "扫描记录不存在", "本次扫描状态无法读取。", "请刷新扫描记录后再试。", False, "retry"),
    ...
    "plan_hash_required": ApiErrorDescriptor("plan_hash_required", "缺少计划摘要", "本次确认未执行。", "请提供当前计划摘要后再试。", False, "reload_settings"),
    ...
    "empty_directory_cleanup_unavailable": ApiErrorDescriptor("empty_directory_cleanup_unavailable", "空目录清理服务暂时不可用", "本次空目录清理没有执行，远端状态没有被伪造更新。", "请检查 115 登录状态和整理权限配置后重试。", True, "retry"),
    "cleanup_scope_unverified": ApiErrorDescriptor("cleanup_scope_unverified", "空目录归属范围未验证", "本次空目录清理未执行，系统没有足够的持久化归属证据。", "请重新完成整理目录登记和媒体库扫描。", False, "refresh_snapshot"),
    ...
    "small_file_cleanup_unavailable": ApiErrorDescriptor("small_file_cleanup_unavailable", "小文件清理服务暂时不可用", "本次小文件清理没有执行，远端状态没有被伪造更新。", "请检查 115 登录状态和整理写权限配置后重试。", True, "retry"),
    "small_file_threshold_unconfigured": ApiErrorDescriptor("small_file_threshold_unconfigured", "小文件阈值未配置", "本次小文件清理未生成预览。", "请先在自动整理设置中配置小文件大小阈值。", False, "reload_settings"),
    "cleanup_snapshot_unavailable": ApiErrorDescriptor("cleanup_snapshot_unavailable", "清理快照不可用", "本次清理未执行，缺少当前完整的扫描快照。", "请先完成一次完整扫描后再试。", True, "refresh_snapshot"),
    "snapshot_stale": ApiErrorDescriptor("snapshot_stale", "清理快照已过期", "本次清理未执行，快照与当前媒体库不一致。", "请重新扫描并刷新快照后重试。", False, "refresh_snapshot"),
    ...
    "invalid_source_index": ApiErrorDescriptor("invalid_source_index", "来源条目标识无效", "本次整理计划未保存。", "请从待确认列表重新选择来源条目。", False),
    ...
    "candidate_source_required": ApiErrorDescriptor("candidate_source_required", "需要选择来源条目", "本次候选搜索未执行，缺少来源影片。", "请先选择要搜索的来源条目。", False),
    "invalid_candidate_query": ApiErrorDescriptor("invalid_candidate_query", "搜索关键词无效", "本次候选搜索未执行。", "请检查搜索关键词后重试。", False),
    "invalid_candidate_limit": ApiErrorDescriptor("invalid_candidate_limit", "候选数量上限无效", "本次候选搜索未执行。", "请使用有效的候选数量上限。", False),
    "candidate_search_unavailable": ApiErrorDescriptor("candidate_search_unavailable", "候选搜索暂不可用", "本次候选搜索没有完成，页面内容没有更新。", "请稍后重试。", True, "retry"),
    ...
    "no_video_files": ApiErrorDescriptor("no_video_files", "没有可整理的视频文件", "本次整理预览未生成，扫描来源没有可整理的视频文件。", "请先扫描包含视频文件的来源目录。", False),
    "plan_expired": ApiErrorDescriptor("plan_expired", "整理计划已过期", "本次整理操作未执行。", "请重新扫描并生成整理计划。", False, "refresh_snapshot"),
    "source_directory_not_found": ApiErrorDescriptor("source_directory_not_found", "扫描来源不存在", "本次整理预览未生成，扫描来源目录不存在。", "请检查整理来源目录后再试。", False),
    "source_scope_unverified": ApiErrorDescriptor("source_scope_unverified", "源目录范围未验证", "本次整理未执行，源目录范围没有得到可靠验证。", "请重新完成整理目录登记后重试。", False, "inspect_configuration"),
    "source_target_overlap": ApiErrorDescriptor("source_target_overlap", "扫描来源与整理目标重叠", "本次整理预览未生成，来源与目标目录重叠。", "请调整整理目录配置后重试。", False, "inspect_configuration"),
    ...
    "organization_execution_unavailable": ApiErrorDescriptor("organization_execution_unavailable", "整理执行能力暂不可用", "本次整理操作未排队，也未执行远端写入。", "请检查 115 登录状态、整理权限和后台服务后再试。", False, "inspect_configuration"),
    ...
    "organization_write_unverified": ApiErrorDescriptor("organization_write_unverified", "真实整理写入契约未验收", "本次 115 写入操作未执行。", "请先完成受管测试目录的写入验收。", False, "inspect_configuration"),
    ...
    "contract_unverified": ApiErrorDescriptor("contract_unverified", "115 整理写入契约尚未验收", "本次 115 写入操作未执行。", "请先完成受管测试目录的写入验收。", False, "inspect_configuration"),
    ...
    "directory_ownership_unavailable": ApiErrorDescriptor("directory_ownership_unavailable", "归档目录归属记录不可用", "本次目标目录没有创建，系统无法建立持久化归属证据。", "请检查数据库迁移和整理状态后重试。", True, "retry"),
    "directory_ownership_unrecorded": ApiErrorDescriptor("directory_ownership_unrecorded", "归档目录归属记录缺失", "远端目录写入结果待核对，系统不会自动重复创建。", "请先核对 115 远端目录和本地整理记录。", False, "view_task"),
    ...
    "invalid_lease_duration": ApiErrorDescriptor("invalid_lease_duration", "租约时长无效", "本次租约操作未执行。", "请使用大于零的有效租约时长。", False),
    "invalid_workflow_id": ApiErrorDescriptor("invalid_workflow_id", "工作流标识无效", "本次整理操作未执行。", "请从有效的工作流重新操作。", False),
    ...
    "workflow_stage_missing": ApiErrorDescriptor("workflow_stage_missing", "工作流整理阶段不存在", "本次整理操作未执行。", "请从有效的整理阶段重新操作。", False),
    ...
    # --- STRM operation (H9) ---
    "strm_operation_claim_conflict": ApiErrorDescriptor("strm_operation_claim_conflict", "STRM 操作正在执行", "本次请求未重复执行，同类操作仍在运行。", "请稍后刷新操作状态，等待当前操作完成后再试。", True, "retry"),
    "strm_operation_creation_conflict": ApiErrorDescriptor("strm_operation_creation_conflict", "STRM 操作创建冲突", "本次操作未创建，同类操作已存在。", "请刷新操作列表，等待现有操作完成后再试。", True, "retry"),
    "strm_operation_lease_required": ApiErrorDescriptor("strm_operation_lease_required", "需要 STRM 操作执行权", "本次操作未执行，缺少有效的执行租约。", "请从操作详情重新发起，或等待执行权恢复后再试。", False, "view_task"),
    "strm_operation_not_reconcilable": ApiErrorDescriptor("strm_operation_not_reconcilable", "STRM 操作无法核对", "本次只读核对未执行，操作没有可核对的远端标识。", "请查看操作状态；只有已取得远端标识的操作才能核对。", False, "view_task"),
    "strm_operation_not_running": ApiErrorDescriptor("strm_operation_not_running", "STRM 操作未在运行", "本次操作未执行，当前操作不在运行状态。", "请查看操作当前状态后重试。", False, "view_task"),
    "strm_full_failed": ApiErrorDescriptor("strm_full_failed", "STRM 全量生成失败", "本次全量生成未完成，文件没有全部更新。", "请查看失败明细后重新生成。", True, "retry"),
    "strm_incremental_failed": ApiErrorDescriptor("strm_incremental_failed", "STRM 增量生成失败", "本次增量生成未完成，文件没有全部更新。", "请查看失败明细后重新生成。", True, "retry"),
    "strm_cleanup_failed": ApiErrorDescriptor("strm_cleanup_failed", "STRM 清理失败", "本次清理未完成，部分文件未清理。", "请查看失败明细后重新清理。", True, "retry"),
    "invalid_cursor": ApiErrorDescriptor("invalid_cursor", "翻页游标无效", "本次列表未加载。", "请刷新列表后重新翻页。", False),
    "invalid_limit": ApiErrorDescriptor("invalid_limit", "每页数量无效", "本次列表未加载。", "请调整每页数量后重试。", False),
    # --- task / webhook / device (H9) ---
    "task_lease_active": ApiErrorDescriptor("task_lease_active", "任务执行权仍有效", "任务仍在运行，本次操作未执行。", "请等待任务完成或取消后再试。", False, "view_task"),
    "webhook_endpoint_disabled": ApiErrorDescriptor("webhook_endpoint_disabled", "Webhook 端点已停用", "本次投递未发送，端点当前处于停用状态。", "请先在设置中启用该端点。", False, "reload_settings"),
    "device_unavailable": ApiErrorDescriptor("device_unavailable", "登录设备服务暂时不可用", "本次设备操作未完成。", "请稍后重试。", True, "retry"),
    "invalid_device_code": ApiErrorDescriptor("invalid_device_code", "设备代码无效", "本次设备操作未执行。", "请检查设备代码后重试。", False),
    "invalid_device_name": ApiErrorDescriptor("invalid_device_name", "设备名称无效", "本次设备操作未执行。", "请检查设备名称后重试。", False),
    # --- organization preview (H9) ---
    "invalid_small_file_threshold": ApiErrorDescriptor("invalid_small_file_threshold", "小文件阈值无效", "本次整理预览未生成。", "请检查小文件阈值设置后重试。", False, "reload_settings"),
    "target_file_invalid": ApiErrorDescriptor("target_file_invalid", "目标文件无效", "本次目标文件未处理。", "请检查目标文件后再试。", False),
    # --- settings validation (H9) ---
    "invalid_poll_interval": ApiErrorDescriptor("invalid_poll_interval", "轮询间隔无效", "本次设置未保存。", "请调整轮询间隔后重试。", False, "reload_settings"),
    "invalid_conflict_mode": ApiErrorDescriptor("invalid_conflict_mode", "冲突处理方式无效", "本次设置未保存。", "请选择有效的冲突处理方式后重试。", False, "reload_settings"),
    "invalid_scan_interval_minutes": ApiErrorDescriptor("invalid_scan_interval_minutes", "扫描间隔无效", "本次设置未保存。", "请调整扫描间隔后重试。", False, "reload_settings"),
    # --- target catalog (H9) ---
    "target_directory_id_invalid": ApiErrorDescriptor("target_directory_id_invalid", "目标目录标识无效", "本次目标目录未读取。", "请检查整理计划的目标目录配置。", False, "reload_settings"),
    "target_directory_limit_invalid": ApiErrorDescriptor("target_directory_limit_invalid", "目标目录数量上限无效", "本次目标目录未读取。", "请检查目标目录数量限制配置。", False, "reload_settings"),
    "target_file_limit_invalid": ApiErrorDescriptor("target_file_limit_invalid", "目标文件数量上限无效", "本次目标文件未读取。", "请检查目标文件数量限制配置。", False, "reload_settings"),
    "target_directory_incomplete": ApiErrorDescriptor("target_directory_incomplete", "目标目录读取不完整", "本次目标目录未完整读取，无法继续。", "请稍后重新读取目标目录。", True, "retry"),
    "target_file_limit_exceeded": ApiErrorDescriptor("target_file_limit_exceeded", "目标文件数量超限", "目标目录文件过多，本次未继续。", "请减少目标目录文件或分批处理。", False),
    "target_file_name_invalid": ApiErrorDescriptor("target_file_name_invalid", "目标文件名无效", "本次目标文件未读取。", "请检查目标文件名。", False),
    "target_file_identity_conflict": ApiErrorDescriptor("target_file_identity_conflict", "目标文件身份冲突", "本次目标文件读取不一致。", "请重新读取目标目录。", True, "retry"),
    "target_directory_name_invalid": ApiErrorDescriptor("target_directory_name_invalid", "目标目录名无效", "本次目标目录未读取。", "请检查目标目录名。", False),
    "target_directory_path_conflict": ApiErrorDescriptor("target_directory_path_conflict", "目标目录路径冲突", "本次目标目录读取不一致。", "请重新读取目标目录。", True, "retry"),
    "target_directory_identity_conflict": ApiErrorDescriptor("target_directory_identity_conflict", "目标目录身份冲突", "本次目标目录读取不一致。", "请重新读取目标目录。", True, "retry"),
    "target_directory_limit_exceeded": ApiErrorDescriptor("target_directory_limit_exceeded", "目标目录数量超限", "目标目录数量过多，本次未继续。", "请减少目标目录或分批处理。", False),
    "target_directory_pagination_unverified": ApiErrorDescriptor("target_directory_pagination_unverified", "目标目录分页未验证", "目标目录读取可能不完整。", "请稍后重新读取目标目录。", True, "retry"),
    "target_entry_type_unverified": ApiErrorDescriptor("target_entry_type_unverified", "目标条目类型未验证", "目标条目读取不完整。", "请稍后重新读取目标目录。", True, "retry"),
    "target_entry_scope_unverified": ApiErrorDescriptor("target_entry_scope_unverified", "目标条目范围未验证", "目标条目超出受管范围。", "请检查整理范围配置后重试。", False, "reload_settings"),
    "target_entry_identity_unverified": ApiErrorDescriptor("target_entry_identity_unverified", "目标条目身份未验证", "目标条目读取不完整。", "请稍后重新读取目标目录。", True, "retry"),
    "target_directory_read_failed": ApiErrorDescriptor("target_directory_read_failed", "目标目录读取失败", "本次未读取到可靠的目标目录内容。", "请检查 115 登录状态后重试。", True, "retry"),
}
...
_HTTP_STATUSES: dict[str, int] = {
    ...
    "directory_ownership_unavailable": 503,
    "confirmation_required": 409,
    "cleanup_snapshot_unavailable": 409,
    "small_file_cleanup_unavailable": 503,
    "small_file_threshold_unconfigured": 422,
    "snapshot_stale": 409,
    ...
    "organization_operation_unavailable": 503,
    "organization_plan_unavailable": 503,
    "organization_reconciliation_unavailable": 503,
    "plan_digest_mismatch": 409,
    "plan_digest_required": 422,
    "plan_expired": 409,
    "plan_hash_mismatch": 409,
    "plan_hash_required": 422,
    ...
    # STRM operations (H9)
    "strm_operation_claim_conflict": 409,
    "strm_operation_creation_conflict": 409,
    "strm_operation_lease_required": 409,
    "strm_operation_not_reconcilable": 409,
    "strm_operation_not_running": 409,
    "strm_full_failed": 409,
    "strm_incremental_failed": 409,
    "strm_cleanup_failed": 409,
    "invalid_cursor": 422,
    "invalid_limit": 422,
    # task / webhook / device (H9)
    "task_lease_active": 409,
    "webhook_endpoint_disabled": 409,
    "device_unavailable": 503,
    "invalid_device_code": 422,
    "invalid_device_name": 422,
    # organization preview / settings validation (H9)
    "invalid_small_file_threshold": 422,
    "target_file_invalid": 409,
    "invalid_poll_interval": 422,
    "invalid_conflict_mode": 422,
    "invalid_scan_interval_minutes": 422,
    # target catalog (H9)
    "target_directory_id_invalid": 409,
    "target_directory_limit_invalid": 422,
    "target_file_limit_invalid": 422,
    "target_directory_incomplete": 409,
    "target_file_limit_exceeded": 409,
    "target_file_name_invalid": 422,
    "target_file_identity_conflict": 409,
    "target_directory_name_invalid": 422,
    "target_directory_path_conflict": 409,
    "target_directory_identity_conflict": 409,
    "target_directory_limit_exceeded": 409,
    "target_directory_pagination_unverified": 409,
    "target_entry_type_unverified": 409,
    "target_entry_scope_unverified": 409,
    "target_entry_identity_unverified": 409,
    "target_directory_read_failed": 503,
}
