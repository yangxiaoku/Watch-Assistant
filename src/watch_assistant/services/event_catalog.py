...
EVENT_CATALOG: dict[str, EventDefinition] = {
    ...
    "backup.deleted": _event(
        "backup.deleted",
        LogCategory.SECURITY,
        "备份已删除",
        "旧备份已删除，状态：{status}，数量：{count}",
        suggestion="请确认仍保留可用备份",
    ),
    "backup.delete_failed": _event(
        "backup.delete_failed",
        LogCategory.SECURITY,
        "备份删除失败",
        "备份删除失败，错误码：{error_code}",
        suggestion="请保留备份目录并核对文件状态",
    ),
    "backup.encrypted_copy_created": _event(
        "backup.encrypted_copy_created",
        LogCategory.SECURITY,
        "加密备份副本已创建",
        "加密备份副本已创建，状态：{status}，数量：{count}",
        suggestion="请将独立恢复密钥保存在受控位置",
    ),
    "backup.encrypted_copy_failed": _event(
        "backup.encrypted_copy_failed",
        LogCategory.SECURITY,
        "加密备份副本创建失败",
        "加密备份副本创建失败，错误码：{error_code}",
        suggestion="请核对受控目标目录和恢复密钥，不要记录密钥内容",
    ),
